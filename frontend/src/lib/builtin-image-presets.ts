...
const DEFAULT_BUILTIN_IMAGE_PRESETS: Record<BuiltinImagePresetId, BuiltinImagePreset> = {
  ...
  'gpt-image-2': { id: 'gpt-image-2', protocol: 'openai', name: 'GPT Image 2', modelId: 'gpt-image-2', baseUrl: 'https://api.openai.com', maxRefImages: 16, maxOutputSize: '4K', supportsAdvancedParams: true, supportsTemperature: false, streamImages: true },
